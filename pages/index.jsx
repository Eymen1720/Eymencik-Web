  ...
  return (
    <>
      ...
      <img width="500" src="/img/bck.png" />
       ...
       Eymencik ne mi işe yarar? Hem sunucunuzda güvenliği hemde eğlenceği sağlayan bir moderasyon ve eğlence botudur.
	  </p>
        <div className="animateHeader mt-10 flex flex-wrap items-center justify-center gap-x-4">
  
            <Link href={"https://discord.com/oauth2/authorize?client_id=857899937143848970&scope=bot&permissions=27648860222"}>
              <a
                className={
...
Vote Eymencik</a>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-y-12 lg:gap-y-0 lg:gap-x-12 py-24">
          <div className="col-span-4">
            ...
            <a href="https://discord.com/oauth2/authorize?client_id=857899937143848970&scope=bot&permissions=27648860222ÿ" className={"mt-10 flex items-center px-4 justify-center gap-x-2 shadow-lg shadow-amber-600/20 cursor-pointer rounded-xl py-4 font-medium bg-gradient-to-r from-amber-700 to-amber-500 hover:opacity-80 transition duration-200 text-white"}>
              <i className="fab fa-discord mr-2" />Invite Eymencik
            </a>
          </div>
          ...
          <div className="col-span-8 grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <div>
                <div className="text-white">
                  ...
                  <p className="text-gray-500 line-clamp-4">Eymencik hem moderasyon hemde eğlence botudur
		  </p>
                </div>
              </div>
              <div>
                <div className="text-white">
                  ...
                  <p className="text-gray-500 line-clamp-4">A bot power BDFD</p>
                </div>
              </div>
              <div>
                <div className="text-white">
      ...
      <div className="flex flex-row w-full h-auto lg:h-56 my-14 lg:my-40 bg-gradient-to-br lg:px-30 from-neutral-900/90 flex items-center justify-start to-neutral-900/50 rounded-lg p-1 shadow-md">
              <>
                <div className="lg:mx-4 lg:p-8 py-4 lg:py-16 flex items-center justify-center flex-col text-center w-full lg:w-auto lg:text-left lg:flex-none">
                  ...
                  <p className="text-md text-white font-medium text-gray-500 line-clamp-5">Are you ready to throw the best parties with Eymencik, the best and most up-to-date bot?</p>
                </div>
