export default function Privacy() {
    ...
    return (
        <div>
            <h1 className="font-semibold text-3xl text-white/75">Privacy Policy for Eymencik</h1>
            <p className="text-sm text-white/30 mb-4">Last Update: 28/01/2024  🆕️</p>
  <div className="animateHeader text-white text-opacity-40 mt-5">
        ...
        <p>⊳ Every user can use the Eymencik bot however they want, as long as they do not intend to harm.</p>
        <div className="py-3"></div>
